...
def finetune_opts(parser):
    # Path options.
    parser.add_argument("--pretrained_model_path", default="models/pre-trained_model.bin", type=str,
    ...
    parser.add_argument("--method", choices=["ERM", "MPTS", "GDRO", "RO", "MGPTS", "MMPTS", "RCC"], default="ERM",
